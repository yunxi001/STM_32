...
//	   HAL_GPIO_WritePin(GPIOB, LED1_Pin, GPIO_PIN_RESET);; // green led blink indicate can comunication successful 
...
/**
  ...
  * @retval None
  */
void set_holdermotor_voltage(int16_t v1, int16_t v2,int16_t v3)
{
